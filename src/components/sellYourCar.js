...
const SellYourCar = () => {
  return (
    <div className="sell-your-car-section" style={{ backgroundImage: `url(${carBg})` }}>
      <div className="sell-your-car-overlay">
        <h2 className="sell-your-car-title">Sell Your Car</h2>
        <p className="sell-your-car-desc">Find your saved searches right here. Get alerts for new listings.</p>
