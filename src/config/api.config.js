...
const API_CONFIG = {
  ...
  return url;
      ...
      GET_DOWNLOAD_REPORT: '/api/cars/download-error-report',
      POST_SELLER_PROFILE: '/api/users/get_user_cars',
      POST_BULK_UPLOAD: (status) => `/api/cars/upload-cars-csv?status=${status}`,
      GET_DOWNLOAD_TEMPLATE: '/api/cars/download-cars-csv-template',
